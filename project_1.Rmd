...
```{r}
get_sr<-function(franchiseId=NULL){
  ...
  if(is.null(franchiseId))
  {
    ...
    get_sr<-GET(paste0("https://records.nhl.com/site/api/franchise-season-records?cayenneExp=franchiseId=",franchiseId))
  }
   ...
   if(is.null(franchiseId))
  {
    return(json_sr)
      ...
      return(json_sr$data[which(json_sr$data$franchiseId %in% franchiseId),] )
  }
...
```{r}
get_goalie<-function(franchiseId=NULL){
...
if(is.null(franchiseId))
  {
    ...
    get_goalie<-GET(paste0("https://records.nhl.com/site/api/franchise-goalie-records?cayenneExp=franchiseId=",franchiseId))
  }
   ...
   if(is.null(franchiseId))
  {
    return(json_goalie)
      ...
      return(json_goalie$data[which(json_goalie$data$franchiseId %in% franchiseId),] )
  }
...
```{r}
get_skater<-function(franchiseId=NULL){
 ...
 if(is.null(franchiseId))
  {
    ...
    get_skater<-GET(paste0("https://records.nhl.com/site/api/franchise-skater-records?cayenneExp=franchiseId=",franchiseId))
  }
   ...
   if(is.null(franchiseId))
  {
    return(json_skater)
      ...
      return(json_skater$data[which(json_skater$data$franchiseId %in% franchiseId),] )
  }
...
```{r}
get_teams <- function(id=NULL,name=NULL)
{
 ...
 if(is.null(id)&(is.null(name)))
  {
    return(json_teams)
      ...
      return(json_teams$teams[which((json_teams$teams$id %in% id)|(json_teams$teams$name %in% name)),])
  }
